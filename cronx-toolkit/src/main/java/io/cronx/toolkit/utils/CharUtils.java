...
public class CharUtils {
    ...
    static {
        for (int i = 127; i >= 0; i--) {
            ...
            CharUtils.CHAR_ARRAY[i] = Character.valueOf((char) i);
        }
    }
     ...
     * </p>
     * <p>
     * This constructor i public to permit tools that require a JavaBean instance to operate.
     * </p>
     */
    public CharUtils(){
        super();
     ...
     * @return {@code true} if {@code ch} is a high-surrogate code unit; {@code false} otherwise.
     */
