 ...
 * </ul>
 * <p>
 * <code>StringUtils</code> handles <code>null</code> input Strings quietly. That is to say that a <code>null</code> input will return <code>null</code>. Where a <code>boolean</code> or
 * <code>int</code> is being returned details vary by method.
 * </p>
 * <p>
...
public class StringUtils {
     ...
     * @return the trimmed String, or an empty String if <code>null</code> input
     */
    public static String trimStart(final String str, char trimChar) {
     ...
     * @return the trimmed String, or an empty String if <code>null</code> input
     */
    public static String trimEnd(final String str, char trimChar) {
        if (str == null || str.equals("")) {
            return str;
        }
     ...
     * @return the trimmed String, or an empty String if <code>null</code> input
     */
    public static String trim(final String str, char trimChar) {
        if (str == null || str.equals("")) {
            return str;
        }
     ...
     * </p>
     * <p>
     * A new array is returned each time, except for length zero. A <code>null</code> array will return <code>null</code>. An empty array will return itself. A <code>null</code> array entry will be
     * ignored.
     * </p>
     *
     * <pre>
     ...
     * <p>
     * A new array is returned each time, except for length zero. A <code>null</code> array will return <code>null</code>. An empty array will return itself. A <code>null</code> array entry will be
     * ignored. A <code>null</code> stripChars will strip whitespace as defined by {@link Character#isWhitespace(char)}.
     * </p>
     *
     * <pre>
     * StringUtils.stripAll(null, *)                = null
     ...
     * </p>
     * <p>
     * A <code>null</code> or empty ("") String will return <code>(INDEX_NOT_FOUND) -1</code>. A negative start position is treated as zero. A start position greater than the string length returns
     * <code>-1</code>.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A negative start position is treated as zero. An empty ("") search String always matches. A start position greater than the string length
     * only matches an empty search String.
     * </p>
     *
     * <pre>
     * StringUtils.indexOf(null, *, *)          = -1
     ...
     * </p>
     * <p>
     * A <code>null</code> or empty ("") String will return <code>-1</code>. A negative start position returns <code>-1</code>. A start position greater than the string length searches the whole
     * string.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A negative start position returns <code>-1</code>. An empty ("") search String always matches unless the start position is negative. A
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A <code>null</code> or empty search string will return <code>-1</code>.
     * </p>
     *
     * <pre>
     * StringUtils.indexOfAnyBut(null, *)            = -1
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>false</code>. A <code>null</code> valid character array will return <code>false</code>. An empty String (length()=0) always returns
     * <code>true</code>.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>false</code>. A <code>null</code> valid character String will return <code>false</code>. An empty String (length()=0) always returns
     * <code>true</code>.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>true</code>. A <code>null</code> invalid character array will return <code>true</code>. An empty String (length()=0) always returns true.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A <code>null</code> or zero length search array will return <code>-1</code>. A <code>null</code> search array entry will be ignored, but
     * a search array containing "" will return <code>0</code> if <code>str</code> is not null. This method uses {@link String#indexOf(String)}.
     * </p>
     *
     * <pre>
     * StringUtils.indexOfAny(null, *)                     = -1
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A <code>null</code> search array will return <code>-1</code>. A <code>null</code> or zero length search array entry will be ignored, but
     * a search array containing "" will return the length of <code>str</code> if <code>str</code> is not null. This method uses {@link String#indexOf(String)}
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * The returned substring starts with the character in the <code>start</code> position and ends before the <code>end</code> position. All position counting is zero-based -- i.e., to start at the
     * beginning of the string use <code>start = 0</code>. Negative start and end positions can be used to specify offsets relative to the end of the String.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * If <code>len</code> characters are not available, or the String is <code>null</code>, the String will be returned without an exception. An empty String is returned if len is negative.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * If <code>len</code> characters are not available, or the String is <code>null</code>, the String will be returned without an an exception. An empty String is returned if len is negative.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * If <code>len</code> characters are not available, the remainder of the String will be returned without an exception. If the String is <code>null</code>, <code>null</code> will be returned. An
     * empty String is returned if len is negative or exceeds the length of <code>str</code>.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> string input will return <code>null</code>. An empty ("") string input will return the empty string. A <code>null</code> separator will return the empty string if the input
     ...
     * </p>
     * <p>
     * A <code>null</code> string input will return <code>null</code>. An empty ("") string input will return the empty string. An empty or <code>null</code> separator will return the empty string if
     ...
     * </p>
     * <p>
     * If more than <code>max</code> delimited substrings are found, the last returned string includes all characters after the first <code>max - 1</code> returned strings (including separator
     * characters).
     * </p>
     *
     * <pre>
     ...
     * @param separator String containing the String to be used as a delimiter, <code>null</code> splits on whitespace
     * @param max the maximum number of elements to include in the returned array. A zero or negative value implies no limit.
     * @param preserveAllTokens if <code>true</code>, adjacent separators are treated as empty token separators; if <code>false</code>, adjacent separators are treated as one separator.
     * @return an array of parsed Strings, <code>null</code> if null String input
     * @since 2.4
     */
    ...
    /**
     * <p>
     * Splits the provided text into an array, using whitespace as the separator, preserving all tokens, including empty tokens created by adjacent separators. This is an alternative to using
     ...
     * </p>
     * <p>
     * A <code>null</code> source string will return <code>null</code>. An empty ("") source string will return the empty string. A <code>null</code> remove string will return the source string. An
     * empty ("") remove string will return the source string.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * The length of the search characters should normally equal the length of the replace characters. If the search characters is longer, then the extra search characters are deleted. If the search
     ...
     * </p>
     * <p>
     * A <code>null</code> string input returns <code>null</code>. A negative index is treated as zero. An index greater than the string length is treated as the string length. The start index is
     ...
     * </p>
     * <p>
     * NOTE: This method changed in version 2.0. It now more closely matches Perl chomp. For the previous behavior, use {@link #substringBeforeLast(String, String)}. This method uses
     ...
     * </pre>
     * <p>
     * Note: this method doesn't not support padding with <a href="http://www.unicode.org/glossary/#supplementary_character">Unicode Supplementary Characters</a> as they require a pair of
     * <code>char</code>s to be represented. If you are needing to support full I18N of your applications consider using {@link #repeat(String, int)} instead.
     * </p>
     *
     ...
     * </pre>
     * <p>
     * <strong>Note:</strong> As described in the documentation for {@link String#toUpperCase()}, the result of this method is affected by the current locale. For platform-independent case
     * transformations, the method {@link #lowerCase(String, Locale)} should be used with a specific locale (e.g. {@link Locale#ENGLISH}).
     * </p>
     *
     ...
     * </pre>
     * <p>
     * <strong>Note:</strong> As described in the documentation for {@link String#toLowerCase()}, the result of this method is affected by the current locale. For platform-independent case
     * transformations, the method {@link #lowerCase(String, Locale)} should be used with a specific locale (e.g. {@link Locale#ENGLISH}).
     * </p>
     *
     ...
     * </p>
     * <p>
     * Works like <code>abbreviate(String, int)</code>, but allows you to specify a "left edge" offset. Note that this left edge is not necessarily going to be the leftmost character in the result, or
     * the first character following the ellipses, but it will appear somewhere in the result.
     * <p>
     ...
     * <li>The abbreviated String will have enough room for the length supplied replacement String and the first and last characters of the supplied String for abbreviation</li>
     * </ul>
    ...
    public static int getLevenshteinDistance(String s, String t) {
         ...
         * switched...this is clearly much better than cloning an array or doing a System.arraycopy() each time through the outer loop.) Effectively, the difference between the two implementations is
         * this one does not cause an out of memory condition when calculating the LD over two very large strings.
         */
     ...
     * @return <code>true</code> if the String starts with any of the the prefixes, case insensitive, or both <code>null</code>
     * @since 2.5
     */
     ...
     * </p>
     * <p>
     * The function returns the argument string with whitespace normalized by using <code>{@link #trim(String)}</code> to remove leading and trailing whitespace and then replacing sequences of
     * whitespace characters by a single space.
     * </p>
     * In XML Whitespace characters are the same as those allowed by the <a href="http://www.w3.org/TR/REC-xml/#NT-S">S</a> production, which is S ::= (#x20 | #x9 | #xD | #xA)+
     * <p>
     * See Java's {@link Character#isWhitespace(char)} for which characters are considered whitespace.
     * <p>
     * The difference is that Java's whitespace includes vertical tab and form feed, which this functional will also normalize. Additonally <code>{@link #trim(String)}</code> removes control
     * characters (char &lt;= 32) from both ends of this String.
     * </p>
     *
     * @see Character#isWhitespace(char)
     * @see #trim(String)
     * @see <ahref="http://www.w3.org/TR/xpath/#function-normalize-space"> http://www.w3.org/TR/xpath/#function-normalize-space</a>
     ...
     * @param string the String to check, may be null
     * @param searchStrings the Strings to find, may be null or empty
     * @return <code>true</code> if the String ends with any of the the prefixes, case insensitive, or both <code>null</code>
     * @since 2.6
     */
    ...
    //
    // -----------------------------------------------------------------------
    public static Map<String, String> toMap(String stringBody) {
        return toMap(stringBody, ";", "=");
    }

    public static Map<String, String> toMap(String stringBody, String separator, String delimited) {
        Map<String, String> result = new HashMap<>();

        if (isNotBlank(stringBody)) {
            for (String item : split(stringBody, separator)) {
                String[] kv = split(item, delimited);
                if (kv.length == 1) {
    ...
    public static Map<String, List<String>> toArrayMap(String stringBody) {
        return toArrayMap(stringBody, ";", "=");
    }

    public static Map<String, List<String>> toArrayMap(String stringBody, String separator, String delimited) {
        ...
        if (isNotBlank(stringBody)) {
            for (String item : split(stringBody, separator)) {
                String[] kv = split(item, delimited);
                if (kv.length == 1) {
                    result.computeIfAbsent(kv[0], s -> new ArrayList<>()).add(null);
                } else {
                    result.computeIfAbsent(kv[0], s -> new ArrayList<>()).add(kv[1]);
                }
            }
        }
