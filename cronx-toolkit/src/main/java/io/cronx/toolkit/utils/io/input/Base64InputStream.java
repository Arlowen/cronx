...
public class Base64InputStream extends InputStream {
    ...
    private byte[] decode(final String source) {
        ...
        for (int eLen = len / 3 * 3; d < eLen;) {
            ...
            int i = Base64InputStream.IA[source.charAt(sIx++)] << 18 | Base64InputStream.IA[source.charAt(sIx++)] << 12 | Base64InputStream.IA[source.charAt(sIx++)] << 6
                    | Base64InputStream.IA[source.charAt(sIx++)];
            // Add the bytes
            dArr[d++] = (byte) (i >> 16);
            dArr[d++] = (byte) (i >> 8);
            dArr[d++] = (byte) i;
