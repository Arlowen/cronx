...
public class ObjectUtils {
     ...
     * </p>
     * <p>
     * For example, in a <code>HashMap</code> the {@link java.util.HashMap#get(Object)} method returns <code>null</code> if the <code>Map</code> contains <code>null</code> or if there is no matching
     * key. The <code>Null</code> placeholder can be used to distinguish between these two cases.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Appends the toString that would be produced by <code>Object</code> if a class did not override toString itself. <code>null</code> will throw a NullPointerException for either of the two
     * parameters.
     * </p>
     *
     * <pre>
     ...
     * @param c1 the first comparable, may be null
     * @param c2 the second comparable, may be null
     * @param nullGreater if true <code>null</code> is considered greater than a Non-<code>null</code> value or if false <code>null</code> is considered less than a Non-<code>null</code> value
     * @return a negative value if c1 < c2, zero if c1 = c2 and a positive value if c1 > c2
    ...
    /**
     * Checks that the given argument is in range. If it is not, throws {@link IllegalArgumentException}. Otherwise, returns the argument.
     */
    ...
    public static <T, S> S tryCastConvert(Object obj, Class<T> clazz, Function<? super T, ? extends S> convertor) {
        // noinspection unchecked
        return clazz.isInstance(obj) ? convertor.apply((T) obj) : null;
    }

    public static <T, S> S doConvert(T obj, Function<? super T, ? extends S> function) {
